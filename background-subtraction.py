...
kernel2 = cv2.getStructuringElement(cv2.MORPH_ELLIPSE,(32,32))
...
while True:
    ...
    fg_mask_gmg = cv2.morphologyEx(fg_mask_gmg, cv2.MORPH_CLOSE, kernel2)

    mask_inv = cv2.bitwise_not(fg_mask_gmg)
